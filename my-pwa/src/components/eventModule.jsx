...
function EventModal({ artist, lang, onClose }) {
  ...
  return (
    <div
      className={`fixed inset-0 bg-black/60 z-10000 flex items-center justify-center transition-opacity duration-300 ${
    ...
    >
      <div
        ...
        className="bg-white text-black dark:text-white relative w-3/4 p-3 dark:bg-dark items-center flex flex-col rounded-xl "
      >
        <button
          className="dark:text-graytext text-lightTextM font-bold"
          onClick={handleClose}
        >
          x
        </button>
